 ...
 * @author Edilva
 */
public class CadastrarCarona implements Command {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (service.salvar(carona)) {
                request.setAttribute("mensagem", "Carona cadastrada com sucesso!");
                try {
                    request.getRequestDispatcher("paginaDeResposta.jsp").forward(request, response);
                } catch (IOException | ServletException ex) {
                    Logger.getLogger(CadastrarCarona.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                request.setAttribute("mensagem", "Erro ao cadastrar carona!");
                try {
                    request.getRequestDispatcher("paginaDeResposta.jsp").forward(request, response);
