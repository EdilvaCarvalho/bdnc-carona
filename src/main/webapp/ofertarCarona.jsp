...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <form method="post" id="oferecerCarona" action="Controller?command=CadastrarCarona">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="dataViagem" id="dataNasc" required>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="horaSaida">Hora de saída: </label>
                            <input type="text" class="form-control" name="horaSaida" id="horaSaida" pattern="[0-9]{2}:[0-9]{2}$" placeholder="HH:mm" maxlength="5" title="HH:mm" required>
                        </div>
                        <div class="form-group col-md-12">
